...
The Besc blockchain uses a variant of delegated Proof of Stake (dPoS) for achieving [consensus](https://docs.bescscan.io/docs/general/learn-about-the-fuse-platform/fuse-network-blockchain/README.md). The consensus is secured by a significant number of independent validators, only one of which is run by the Besc core team.
