...
To get started on BeanSwap, the first thing you'll need is to set up a wallet that supports BESC  (BESC). Wallets are available both on desktop computers and on smartphone devices. You'll need to choose the wallet that fits your needs best.
...
This comparison table gives an overview of the most popular mobile wallets used with BeanSwap.

|                                                                   | MetaMask | Coinbase Wallet | SafePal                    | Trust Wallet | Token Pocket |
| ----------------------------------------------------------------- | -------- | --------------- | -------------------------- | ------------ | ------------ |
| BESC Chain support                                                | ⚠️       | ✅               | ✅                          | ✅            | ✅            |
...
MetaMask is a very popular browser-based wallet plugin that supports ERC20 (Ethereum network) and BESC.

​**Pros:**

* Open source for auditability
* WEB3 capable on BescScan
...
* Additional steps needed to use with BESC and BeanSwap
...
{% tab title="SafePal" %}
![SafePal is available as both a software and hardware wallet. The wallet is easy to install and create, and comes ready to support BEP2 (BNB Beacon Chain) and BEP20 (BNB Smart Chain) right away.](broken-reference)
...
MetaMask is a very popular browser-based wallet plugin that supports ERC20 (Ethereum network) by default, and BESC & BEP20 (Binance Chain and BNB Smart Chain networks) with a little work.
...
The genuine BeanSwap site and staff will never ask you to input your seed phrase.
{% endhint %}
