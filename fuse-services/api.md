...
The Besc Studio REST API for accessing the data and the services of the Besc network in a simple way. You can use this API to query and interact with the objects of the Besc network such as: Communities, Tokens, Bridges and Entities.

## Bridge

### Fetch bridge

The token bridge connects the Ethereum and Besc network
...
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Home \(Besc\) token address |

#### Success 200

| Name | Type | Description |
| :--- | :--- | :--- |
| homeTokenAddress | `String` | Token address on the Besc network |
...
| homeBridgeAddress | `String` | Bridge address on the Besc network |
| homeBridgeBlockNumber | `Number` | Bridge creation block number on the Besc network |
...
Community is a set of contracts and services. Members of the community are users of the Besc network. The community is configured via the plugins.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Address of the community on the Besc network |
| homeTokenAddress | `String` | Address of the community token on the Besc network |
| foreignTokenAddress | `String` | Address of the community token on the Ethereum network |
| homeBridgeAddress | `String` | Address of the community bridge on the Besc network |
...
| Name | Type | Description |
| :--- | :--- | :--- |
| communityAddress | `String` | Community address of the Besc network |
...
Entity is an account on the Besc network. It can have variety of roles like user, admin, business, or custom defined role.
...
| Name | Type | Description |
| :--- | :--- | :--- |
| account | `String` | Entity's account on Besc network |
