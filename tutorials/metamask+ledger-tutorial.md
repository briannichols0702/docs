...
We will learn how to connect Ledger to Metamask and use it on Besc network after the latest Metamask and Ledger live update.
...
You will be logged in to the address you selected and now you can change to “Besc network” and perform the transactions on Besc network through your Ledger device.

Note: To learn how to add Besc network RPC follow [this link.](https://docs.bescscan.io/the-fuse-studio/getting-started/how-to-add-fuse-to-your-metamask)
